...
variable "primary_acm_certificate_arn" { type = string  description = "ACM cert ARN for the primary ALB HTTPS listener (ap-south-1)" }
...
variable "elb_service_account_id" { type = string  default = "718504428378"  description = "ELB service account for ALB logs (ap-south-1 default)" }
