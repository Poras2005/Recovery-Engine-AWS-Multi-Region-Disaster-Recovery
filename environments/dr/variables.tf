...
# dr_azs      = ["ap-southeast-1a", "ap-southeast-1b"]
# app_port    = 8080
#
# dr_acm_certificate_arn = "arn:aws:acm:ap-southeast-1:123456789012:certificate/yyyyyyyy-yyyy-yyyy-yyyy-yyyyyyyyyyyy"
...
#
# elb_service_account_id = "114774131450"   # ap-southeast-1
